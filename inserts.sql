...
-- Fiziniai asmenys ID>=5000
-- Tiekejo_ID, Vardas, Pavarde, Asmens_kodas

INSERT INTO Fizinis	VALUES	(DEFAULT, 'Jonas', 'Stankevicius', '36911065684');
INSERT INTO Fizinis	VALUES	(DEFAULT, 'Matas', 'Minkivicius', '37803252369');
INSERT INTO Fizinis	VALUES	(DEFAULT, 'Kristupas', 'Kajubauskas', '38106305698');


-- Juridiniai asmenys ID>=4000
-- Tiekejo_ID, Imone, Imones_kodas

INSERT INTO Juridinis	VALUES	(DEFAULT, 'UAB Gintauta', '365205781');
INSERT INTO Juridinis	VALUES	(DEFAULT, 'UAB Getala', '350123785');
INSERT INTO Juridinis	VALUES	(DEFAULT, 'UAB Metaka', '350015482');

-- Pirkejai ID>=3000
-- Pirkejo_ID, Vardas, Pavarde, Konsultantas, AK

INSERT INTO Pirkejas VALUES	(DEFAULT, 'Gintaras', 'Gudavicius', 101, '39301045422');
INSERT INTO Pirkejas VALUES	(DEFAULT, 'Jonas', 'Katauskis', 103, '35910286298');
INSERT INTO Pirkejas VALUES	(DEFAULT, 'Diana', 'Karauskiene', 105, '46603251986');
INSERT INTO Pirkejas VALUES	(DEFAULT, 'Irmantas', 'Radenas', 102, '37908132579');
INSERT INTO Pirkejas VALUES	(DEFAULT, 'Aurimas', 'Janusauskas', 104, '38909213365');
INSERT INTO Pirkejas VALUES	(DEFAULT, 'Kira', 'Kureliene', 101, '37511216982');
...
INSERT INTO Automobilis VALUES   ('Lexus', 'LS430', 2003, 2, 11400, 'Sandelyje', 'JGCAC98A218463058' );
...
INSERT INTO Saskaita VALUES	(1006, 'Fizinis', NULL, 5000, NULL, 'JLSBC98A544321654', 9800, 'Nupirktas', 'Pilnas', '2018-10-19');
INSERT INTO Saskaita VALUES	(1007, 'Fizinis',  NULL, 5001, NULL, 'JGSBC11A321987521', 7300, 'Nupirktas', 'Pilnas', '2018-12-30');
INSERT INTO Saskaita VALUES	(1008, 'Fizinis', NULL, 5002, NULL, 'JCCBC11G258755113', 10500, 'Nupirktas', 'Pilnas', '2019-02-15');
INSERT INTO Saskaita VALUES	(1009, 'Juridinis', NULL, NULL, 4000, 'JRABC66G359001472', 9850, 'Nupirktas', 'Pilnas', '2019-03-17');
INSERT INTO Saskaita VALUES	(1010, 'Juridinis', NULL, NULL, 4001, 'JLSGS34C213548965', 44300, 'Nupirktas', 'Pilnas', '2017-01-12');
INSERT INTO Saskaita VALUES	(1011, 'Fizinis', NULL, 5002, NULL, 'JGCAC98A218463058', 35430, 'Nupirktas', 'Pilnas', '2017-09-07');
INSERT INTO Saskaita VALUES	(1012, 'Juridinis', NULL, NULL, 4002, 'JSABC68G215800311', 15960, 'Nupirktas', 'Pilnas', '2018-02-01');
INSERT INTO Saskaita VALUES	(1013, 'Juridinis', NULL, NULL, 4001, 'JLCBC66D258003155', 16450, 'Nupirktas', 'Pilnas', '2017-12-15');
INSERT INTO Saskaita VALUES	(1014, 'Juridinis', NULL, NULL, 4002, 'JRXAW68G369021103', 98030, 'Nupirktas', 'Pilnas', '2017-01-02');
